...
const PurchaseSuccessPage = () => {
	...
	return (
		<div className="h-screen flex items-center justify-center px-4">
			...
			<div className="max-w-md w-full bg-gray-900 rounded-lg shadow-xl overflow-hidden relative z-10">
             ...
             rounded-lg transition duration-300 flex items-center justify-center"
						...
						<Link
							to={"/"}
							className="w-full bg-gray-800 hover:bg-gray-700 text-indigo-400 font-bold py-2 px-4 
            rounded-lg transition duration-300 flex items-center justify-center"
						>
							Continue Shopping
