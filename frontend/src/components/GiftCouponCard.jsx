...
const GiftCouponCard = () => {
	...
	return (
		<motion.div
			className="space-y-4 rounded-lg border border-gray-600 bg-gray-900 p-4 shadow-sm sm:p-6"
		...
		>
			<div className="space-y-4">
				<div>
					...
					<input
						type="text"
						id="voucher"
						className="block w-full rounded-lg border border-gray-700 bg-gray-800 
			...
			{isCouponApplied && coupon && (
				<div className="mt-4">
					...
					<motion.button
						type="button"
						className="mt-2 flex w-full items-center justify-center rounded-lg bg-blue-600 
            px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none
